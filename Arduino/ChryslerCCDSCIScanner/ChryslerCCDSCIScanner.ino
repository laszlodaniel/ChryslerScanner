...
// SBEC3 (128k).
const uint8_t LdBoot_128k[516] PROGMEM =
{
...
{
    0xfa, 0x00, 0x02, 0x9c, 0xf8, 0x45, 0xb7, 0x02, 0xf8, 0x55, 0xb7, 0x70, 0xb6, 0xee, 0xf5, 0x46, 
    ...
    0xf5, 0x56, 0xfa, 0x00, 0x02, 0x8e, 0xf5, 0x22, 0xfa, 0x00, 0x02, 0x8e, 0x27, 0xf7, 0x17, 0x65, 
...
void unlock_sbec3_bootstrap_mode(uint8_t bootloader_src)
{
    ...
    switch (bootloader_src)
    {
        case 0:
        {
            ...
            for (uint16_t i = 0; i < ARRAY_SIZE(LdBoot_128k); i++)
            {
                pcm_putc(pgm_read_byte(LdBoot_128k + i));
                while (pcm_rx_available() == 0); // wait for echo
                pcm_getc(); // read echo into oblivion
            }
            break;
