...
const uint8_t bootloader_stock_256k[] PROGMEM =
{
    ...
    , 
    ...
    , 
...
const uint8_t bootloader_custom_256k_01[] PROGMEM =
{
    ...
    0x0c, 0x76, 0x01, 0xb7, 0xf4, 0x17, 0xea, 0x7c, 0x0f, 0x37, 0xb5, 0x00, 0x43, 0xfa, 0x00, 0x01, 
    ...
    0x46, 0xfa, 0x00, 0x01, 0x88, 0xfa, 0x00, 0x01, 0x9e, 0x37, 0x9c, 0xfa, 0x00, 0x01, 0x88, 0xfa, 
    0x00, 0x01, 0x9e, 0x17, 0xfa, 0x03, 0x60, 0xfa, 0x00, 0x01, 0x88, 0xfa, 0x00, 0x01, 0x9e, 0x17, 
    0xfa, 0x03, 0x61, 0x17, 0xfc, 0x03, 0x60, 0xfa, 0x00, 0x01, 0x88, 0xfa, 0x00, 0x01, 0x9e, 0x17, 
    0xfa, 0x01, 0xb6, 0xfa, 0x00, 0x01, 0x88, 0xfa, 0x00, 0x01, 0x9e, 0x17, 0xfa, 0x01, 0xb7, 0xfa, 
    0x00, 0x01, 0x88, 0xc5, 0x00, 0xfa, 0x00, 0x01, 0x88, 0x3c, 0x01, 0x27, 0x31, 0x01, 0xb6, 0xb6, 
    0xee, 0x37, 0x80, 0xfd, 0xa2, 0x27, 0x4c
};
    ...
    if (pcm.enabled)
    {
        ...
        if (pcm.speed == LOBAUD) // handle low-speed mode first (7812.5 baud)
        {
            if ((pcm.echo_received || pcm.response_received || pcm.actuator_test_running || pcm.ls_request_running) && (pcm_rx_available() > 0))
            {
                ...
                if (!pcm.ls_request_running && (pcm_rx_available() > 3) && (pcm_peek(0) == 0x2A) && (pcm_peek(1) != 0x00) && (pcm_peek(2) != 0x00))
                {
                    pcm.ls_request_running = true;
                    pcm.ls_request_byte = pcm_peek(1);
                    pcm_getc();
                    pcm_getc();
                }
                else if ((pcm_rx_available() > 2) && (pcm_peek(0) == 0x2A) && (pcm_peek(1) == 0x00) && (pcm_peek(2) == 0x00))
                {
                ...
                {
                    if ((uint32_t)(millis() - pcm.actuator_test_byte_last_millis) >= 200)
                    {
                ...
                else if (pcm.ls_request_running)
                {
                    if ((uint32_t)(millis() - pcm.ls_request_last_millis) >= 200)
                    {
